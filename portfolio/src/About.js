          ...
          <div className="row min-vh-100 gx-5 d-flex justify-content-center">
            ...
            <div className="col-md-6 col-sm-12 d-flex justify-content-center">
              <p className="main-para p-2">
                ...
                code which has been a constant interest to me. <hr></hr>I joined
                Awesome Inc's bootcamp to further my interest in code and to
                create things on a technical level. My main hobby is digital art
                with creating characters, even some small graphic novels
              </p>
            </div>
          </div>
        </div>
